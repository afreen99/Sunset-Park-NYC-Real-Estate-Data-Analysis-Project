---
title: An R Markdown document converted from "Downloads/Sunset_Park_Data_Analysis_Project.ipynb"
...
Prepare Dataset and Quick Overview

```{r}
# Download to a temporary file
url <- "https://www.dsm.business/MET/NYC_REAL_ESTATE_DATA.RData"
...
```{r}
mydata <- filter(all_nyc, NEIGHBORHOOD_NAME == "SUNSET PARK")
dim(mydata)
head(mydata)
write.csv(mydata,"sunset_park.csv")
```
